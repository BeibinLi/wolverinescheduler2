...
<td><input id="dept_in1" type="text" class="class_in" name="dept_in1" value="<?php $var1 = isset($_POST["dept_in1"]) ? $_POST["dept_in1"] : ""; echo $var1; ?>" onclick="changeValueDept()" style="font-family: 'Abel', Arial; color:#000000" /></td>
