...
&nbsp;&nbsp;
<input type="reset" value="CLEAR" style="border-radius:5px; background-color: #DB80000; width:10%; height: 50px;margin:0px; border:0px; font-size:1.6em; font-family: 'Abel', Arial; font-weight:bold">
</form>
</center>
